...
namespace IndirectX.TypeGenerator.Templates
{
 ...
 if (e.Delete)
   { 
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(e.SourceName));
            this.Write("\r\n");
 }
   else
   {
   if (e.IsFlag) { 
            ...
            this.Write("    ");
            this.Write(this.ToStringHelper.ToStringWithCulture(e.Modifier));
            this.Write(" enum ");
            this.Write(this.ToStringHelper.ToStringWithCulture(e.Name));
            this.Write(" : ");
            this.Write(this.ToStringHelper.ToStringWithCulture(e.BaseType));
            this.Write("\r\n    {\r\n");
 if (e.RequiredToMakeFlag) { 
            this.Write("        None = 0,\r\n");
 }
   foreach(var field in e.Cases) { 
            this.Write("        ");
            this.Write(this.ToStringHelper.ToStringWithCulture(field.Name));
            this.Write(this.ToStringHelper.ToStringWithCulture(string.IsNullOrWhiteSpace(field.Value) ? "" : (" = " + field.Value)));
            this.Write(",\r\n");
 } 
            this.Write("    }\r\n");
 } 
